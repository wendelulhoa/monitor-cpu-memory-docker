...
pip3 install requests flask psutil matplotlib docker numpy pandas urllib3 python-dotenv --break-system-packages
pip3 install --upgrade docker --break-system-packages

# Garante que as dependências do Python foram instaladas
pip3 install requests flask psutil matplotlib docker numpy pandas urllib3 python-dotenv
